...
# Base fixtures the module-scoped BLR fixtures below are built from:
#   data_fixtures -> train_arrays (used by norm_data_from_arrays)
#   path_fixtures -> save_dir_blr (used by norm_blr_model)
pytest_plugins = [
